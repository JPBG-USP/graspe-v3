...
m2 = 0.097279     # Link 2
m3 = 0.097279     # Link 3
m_grip = 0.094064 # Garra

# -----------------------------
# centros de massa (mm → m)
# -----------------------------
...
r_grip = [0.007842, 0.004905, 0.384644] # Garra

# -----------------------------
# inércias diagonais (g·mm² → kg·m², fator 1e-9)
# -----------------------------
...
I_grip = np.diag([49916.944, 38851.159, 30025.728]) * 1e-9  # Garra
